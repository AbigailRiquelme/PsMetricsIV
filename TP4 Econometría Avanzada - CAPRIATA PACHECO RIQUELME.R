...
# Tal como escribimos en el informe, tenemos que hacer un cálculo con beta[ln_ing] y beta[jmujer].
...
stargazer(desercion_probit_robust, desercion_mlp_robust, desercion_probit7, type='tex',
          ...
          covariate.labels = c("Mujer", "Educaci?n JH (missing)", "Educación JH (EGB)", "Educación JH (Secundario)",
                               "Educación JH (Polimodal)", "Educación JH (Terciario)", "Educación JH (Universitario)",
                               "Educación JH (Posgrado)",
                               "Cantidad de hermanos", "Ingreso per cápita","Log ingreso per capita", "Jefe de hogar mujer",
